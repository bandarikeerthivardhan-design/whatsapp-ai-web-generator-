...
const App = () => {
  const content = {"about_text": "Apex Motors is the premier luxury vehicle rental service, dedicated to providing an unparalleled driving experience. We cater to enthusiasts, executives, and travelers who demand exceptional performance, pristine vehicle condition, and world-class customer service.", "cta_text": "Explore the Fleet", "feature_descriptions": ["An elite selection of the latest models from Ferrari, Lamborghini, Rolls-Royce, and more.", "Seamless digital booking with personalized white-glove delivery directly to your doorstep or airport terminal.", "Comprehensive premium insurance and 24/7 roadside assistance for absolute peace of mind."], "footer_text": "\u00a9 2024 Apex Motors. All rights reserved. Engineered for those who demand more.", "hero_description": "Experience the pinnacle of performance and luxury. Rent the world\u0027s most exclusive supercars and premium SUVs with Apex Motors.", "hero_heading": "Drive the Extraordinary"};
  const features = ["Online Booking System", "Interactive Fleet Showcase", "VIP Delivery Service", "24/7 Concierge Support"];
  const theme = "dark luxury";
    ...
    <div className={`min-h-screen ${isDark ? 'bg-slate-900 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <nav className="p-6 flex justify-between items-center border-b border-gray-700/50">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-primary">Apex Motors</h1>
        </div>
        <div className="space-x-6 hidden md:flex">
          
          <a href="#" className="hover:text-primary transition-colors capitalize">Home</a>
          
          <a href="#" className="hover:text-primary transition-colors capitalize">Fleet</a>
          
          <a href="#" className="hover:text-primary transition-colors capitalize">About Us</a>
          
          <a href="#" className="hover:text-primary transition-colors capitalize">Services</a>
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto text-center">
        <h3 className="text-3xl font-bold mb-6">About Apex Motors</h3>
      ...
      <footer className={`py-12 px-6 border-t ${isDark ? 'border-gray-800' : 'border-gray-200'}`}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            <h4 className="text-xl font-bold text-primary mb-2">Apex Motors</h4>
            <p className="opacity-60 max-w-xs">{content.footer_text}</p>
          </div>
          <div className="flex flex-col items-center md:items-end">
            <p className="font-medium">Contact Us</p>
            <p className="opacity-70">contact@apexmotors.com</p>
            <p className="opacity-70">+1 (800) 555-0199</p>
          </div>
        </div>
